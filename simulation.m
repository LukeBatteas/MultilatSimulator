...
ws = [[w1;v1;dt1] [w2;v2;dt2] [w3;v3;dt3] [w4;v4;dt4] [w5;v5;dt5;]];
...
for i = 1:length(ws(1,:))
    ...
    block = block.translateBody(v.*dt);
...
%Uses Singular Value Decomposition and throws away the singular values 
